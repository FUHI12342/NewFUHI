...
(function() {
    ...
    function createWidget() {
        ...
        document.getElementById('guide-chat-close').addEventListener('click', toggleChat);
        document.getElementById('guide-chat-send').addEventListener('click', sendMessage);
        document.getElementById('guide-chat-input').addEventListener('keydown', function(e) {
    ...
    function toggleChat() {
        isOpen = !isOpen;
        var win = document.getElementById('guide-chat-window');
        var btn = document.getElementById('guide-chat-btn');
        if (isOpen) {
    ...
    function addMessage(role, text) {
        ...
        bubble.style.cssText = 'max-width:80%;padding:8px 12px;border-radius:12px;line-height:1.5;white-space:pre-wrap;word-break:break-word;' +
            (role === 'user'
                ? 'background:#8c876c;color:#fff;border-bottom-right-radius:4px;'
                : 'background:#f1f0ec;color:#333;border-bottom-left-radius:4px;');
