...
MIDDLEWARE = [
    ...
    "booking.middleware.AdminCSPRelaxMiddleware",
...
# ====================================
from csp.constants import NONCE as _CSP_NONCE

CONTENT_SECURITY_POLICY = {
    "DIRECTIVES": {
        "default-src": ["'self'"],
        "script-src": ["'self'", _CSP_NONCE, "https://cdn.jsdelivr.net", "https://unpkg.com",
                        "https://platform.twitter.com", "https://www.instagram.com"],
        "style-src": ["'self'", "'unsafe-inline'", "https://fonts.googleapis.com"],
        "img-src": ["'self'", "https://www.google.com", "https://*.gstatic.com", "data:", "https:"],
        "connect-src": ["'self'"],
