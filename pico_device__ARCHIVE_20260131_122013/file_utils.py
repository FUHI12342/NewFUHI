...
class FileUtils:
    ...
    @staticmethod
    def save_json_with_backup(file_path: str, data: Dict[str, Any], backup_suffix: str = ".backup") -> bool:
    ...
    @staticmethod
    def restore_from_backup(file_path: str, backup_suffix: str = ".backup") -> bool:
    ...
    @staticmethod
    def cleanup_old_backups(file_path: str, max_backups: int = 3) -> None:
    ...
    @staticmethod
    def safe_file_operation(operation_func, *args, **kwargs) -> tuple[bool, Optional[Any]]:
